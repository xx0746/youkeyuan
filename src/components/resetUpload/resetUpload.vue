    ...
    <el-form ref="form" :model="form" label-width="90px" style="width:80%;margin-left:30px;">
      ...
      <div id="loc1">
        <el-form ref="form2" :model="form2" label-width="120px" :rules="form2list">
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form2.acqTime" type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
      ...
      <div id="loc4" class="hidden">
        <el-form ref="form4" :model="form4" label-width="120px" :rules="form4list">
          ...
          <el-form-item label="出版时间" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form4.booksPublicTime " type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form4.acqTime " type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="资源采集人" style="display:none" label-width="120px">
      ...
      <div id="loc3" class="hidden">
        <el-form ref="form3" :model="form3" label-width="120px" :rules="form3list">
          ...
          <el-form-item label="发表时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form3.achiFbsj " type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="报到时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form3.achiBdsj" type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="交流时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form3.achiJlsj" type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="活动时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form3.achiHdsj" type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form3.acqTime " type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="资源采集人" style="display:none" label-width="120px">
      ...
      <div id="loc2" class="hidden">
        <el-form ref="form5" :model="form5" label-width="120px" :rules="form5list">
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="form5.acqTime" type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="资源采集人" style="display:none" label-width="120px">
      ...
      <div id="loc5" class="hidden">
        <el-form ref="form6" :model="form6" label-width="124px" :rules="form6list">
          ...
          <el-form-item label="申请时间" label-width="124px">
            <div class="block">
              <el-date-picker v-model="form6.patentApplyTime" type="date" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <!---->
          <!--<el-form-item label="专利类别" label-width="120px" style="display:none" id="zhuanlileibie">-->
          <!--<el-input v-model="form6.patentMainType"></el-input>-->
          <!--</el-form-item>-->
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="124px">
            <div class="block">
              <el-date-picker v-model="form6.acqTime" type="date" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
      ...
      <div id="loc6" class="hidden">
        <el-form ref="news" :model="news" label-width="120px" :rules="newslist">
          ...
          <el-form-item label="资源采集时间" label-width="120px">
            <div class="block">
              <el-date-picker v-model="newsDate" type="date" placeholder="选择日期时间"></el-date-picker>
            </div>
          </el-form-item>
      ...
      <div id="loc7" class="hidden">
        <el-form ref="standard" :model="standard" label-width="120px" :rules="standardlist">
          ...
          <el-form-item label="发布日期" label-width="120px">
            <div class="block">
              <el-date-picker v-model="standard.issueDate " type="date" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="实施日期" label-width="120px">
            <div class="block">
              <el-date-picker v-model="standard.implementDate " type="date" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker v-model="standard.acqTime" type="date" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="资源采集人" style="display:none" label-width="120px">
      ...
      <div id="loc8" class="hidden">
        <el-form ref="lab" :model="lab" label-width="120px" :rules="lablist">
          ...
          <el-form-item label="研究形成时间" label-width="120px">
            <div class="block">
              <el-date-picker type="date" placeholder="选择日期" v-model="lab.libAchievementTime "></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="关键词" label-width="120px">
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker type="date" placeholder="选择日期" v-model="lab.acqTime "></el-date-picker>
            </div>
          </el-form-item>
      ...
      <div id="loc9" class="hidden">
        <el-form ref="picture" :model="picture" label-width="120px" :rules="picturelist">
          ...
          <el-form-item label="拍摄时间" label-width="120px">
            <div class="block">
              <el-date-picker type="date" v-model="picture.shotDate" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker type="date" placeholder="选择日期" v-model="picture.acqTime"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="资源采集人" style="display:none" label-width="120px">
      ...
      <div id="loc10" class="hidden">
        <el-form ref="videoForm" :model="videoForm" label-width="120px" :rules="videoFormlist">
          ...
          <el-form-item label="拍摄时间" label-width="120px">
            <div class="block">
              <el-date-picker type="date" v-model="videoForm.shotDate" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="版权" label-width="120px">
          ...
          <el-form-item label="资源采集时间" style="display:none" label-width="120px">
            <div class="block">
              <el-date-picker type="date" v-model="videoForm.acqTime" placeholder="选择日期"></el-date-picker>
            </div>
          </el-form-item>
          <el-form-item label="资源采集人" style="display:none" label-width="120px">
      ...
      <div id="loc17" class="hidden">
        <el-form ref="importForm" :model="importForm" label-width="120px" :rules="importFormlist">
          ...
          <!-- <el-form-item prop="tally" label="标签" label-width="120px">
            <tag-selection :value="datas.value" @tabTwoClick="selectClick"></tag-selection>
          </el-form-item> -->
...
import {
  ...
  resetbook,
  resetzhishichanquan,
  resetstandardInterface,
  resetlabInterface,
  resetpictureInterface,
  resetvideoFormInterface,
  resetimportFormInterface,
  resetresearchFormInterface,
  getFromMenuId
} from "@/api/resetupload";
import {
  getlabelListAllData,
  getTagListAllData,
  getTagcontentData,
          ...
          setTimeout(() => {
            ...
            if (this.successFiles.length == this.uploadlist.length) {
              ...
              if(this.result.fileDirs.length == 0) {
                return reject(`文件传参失败,请删除新加文件后重新上传！`);
              } else {
                return resolve(this.result);
              }
            } else if(this.progress == '100%'){
              this.fileLoading = false;
              return reject(`文件上传失败,请删除新加文件后重新上传！`);
            }
          }, 2000);
        });
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetlunwen(this.form2).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetanliku(this.form5).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetzhishichanquan(this.form6).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetchengguo(this.form3).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetbook(this.form4).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetstandardInterface(this.standard).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetlabInterface(this.lab).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetpictureInterface(this.picture).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              // }
              resetvideoFormInterface(this.videoForm).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetimportFormInterface(this.importForm).then(function(res) {
                if (res.data.code == 1) {
                  _this
                    .$alert("提交成功", "提示", {
                      type: "success"
        ...
        if (valid) {
          this.uploadFileList()
            .then(response => {
              ...
              resetresearchFormInterface(this.researchForm).then(function(res) {
                if (res.data.code == 1) {
