    ...
    <div style="float:left;width:99%;padding:2%;min-height: 500px;">
      ...
      <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
          <el-button class="model-btn" size="small" style="margin-right: 50px;" type="primary4" @click="cancelClose">取消</el-button>
          <el-button class="model-btn" size="small"  type="primary"  @click="newLabelForm()">提交</el-button>
        </span>
      </el-dialog>
      ...
      <el-table
        ...
        <el-table-column align="center" label="操作" width="170" fixed="right">
          <template slot-scope="scope">
            ...
            >修改</diy-btn>
            <diy-btn
              styleType="icon" iconType="icon-del"
          ...
          <el-table-column align="center" width="160" label="操作" class="label-show" fixed="right">
            <template slot-scope="scope">
              <div>
                ...
                <diy-btn
                  styleType="icon" iconType="icon-check"
      ...
      <!-- 新建分组弹窗 -->
      <el-dialog class="dialogTitle" 
        :before-close="groupDiaClose"
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button class="model-btn" type="primary" style="margin-left: 50px;" size="small" @click="creatNewGroupAdd()">提交</el-button>
        </span>
      </el-dialog>
      <!-- 展示标签内容弹窗 -->
...
.el-table--border th, .el-table--border td:last-child {
