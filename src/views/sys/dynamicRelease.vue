  ...
  <div>
    ...
    <div class="filter-container r-menu" style="margin-top:20px;margin-left:20px;margin-right:20px">
      <el-form ref="form" :model="form" :rules="myRule" label-width="100px"
        ...
        <el-form-item>
          <el-button type="primary" :loading="Publish" :disabled="isfileSuccess" style="height:32px" @click.prevent="handlePublish">发布
          </el-button>
        </el-form-item>
      </el-form>
    </div>
...
<script>
  ...
  import {Upload, publish} from '@/api/dynamicList.js'
