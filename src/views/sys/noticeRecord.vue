<template>
  <div v-loading="fileLoading"
    ...
    <el-dialog title="公告详情" class="info-dialog" :visible.sync="dialogTableVisible">
      <show-info :data="tableInfo.sysNotice" :options="option"></show-info>
    </el-dialog>
  </div>
</template>
<script>
import { downloadFile } from "@/utils/utile"
import { systemNoticeDetail } from "@/api/search"
import showInfo from "@/views/rotationchart/showInfo.vue"
import { getList,deleteItem,downLoad,deleteSystemNotice,turnReason } from "@/api/noticelist";
export default {
  components: {
    showInfo
  },
